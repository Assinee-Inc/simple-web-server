...
type StripeConnectService interface {
	CreateConnectAccount(creator *accountmodel.Creator) (string, error)
	...
	UpdateCreatorFromAccount(creator *accountmodel.Creator, account *stripe.Account) error
	GerarLinkRemediacao(creator *accountmodel.Creator) (string, error)
...
func (s *stripeConnectServiceImpl) CreateConnectAccount(creator *accountmodel.Creator) (string, error) {
...
func (s *stripeConnectServiceImpl) UpdateCreatorFromAccount(creator *accountmodel.Creator, account *stripe.Account) error {
...
func (s *stripeConnectServiceImpl) GerarLinkRemediacao(creator *accountmodel.Creator) (string, error) {
	...
	// Fallback: Se LoginLink falhar, usar AccountLink
