...
func main() {
	...
	checkoutHandler := saleshandler.NewCheckoutHandler(templateRenderer, ebookService, clientService, clientRepository, creatorService, commonRFService, salesEmailService, transactionService, purchaseService)
